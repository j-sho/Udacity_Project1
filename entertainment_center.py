...
grease = media.Video("Grease", 
					...
					"https://images-na.ssl-images-amazon.com/images/M/MV5BMTcyMTA5MTY3MF5BMl5BanBnXkFtZTgwMTMwNzAxMDE@._V1_.jpg", 
...
dirty_dancing = media.Video("Dirty Dancing", 
							...
							"https://images-na.ssl-images-amazon.com/images/M/MV5BMTc3MDY3ODQ2OV5BMl5BanBnXkFtZTgwOTQ2NTYxMTE@._V1_.jpg", 
...
ghost = media.Video("Ghost", 
					...
					"https://images-na.ssl-images-amazon.com/images/M/MV5BMTU0NzQzODUzNl5BMl5BanBnXkFtZTgwMjc5NTYxMTE@._V1_.jpg", 
					"https://youtu.be/vIy3MDzPyKg")
bodyguard = media.Video("The Bodyguard", 
						"A former Secret Service agent takes on the job of bodyguard to a pop singer, "
						"whose lifestyle is most unlike a President's.", 
						"https://images-na.ssl-images-amazon.com/images/M/MV5BYjNhMGEwNDYtOTYxZC00NmY3LWI0ZmMtMDdmZTU2OTgzMDYwXkEyXkFqcGdeQXVyMTQxNzMzNDI@._V1_.jpg", 
...
schindler = media.Video("Schindler's List", 
						...
						"https://images-na.ssl-images-amazon.com/images/M/MV5BMzMwMTM4MDU2N15BMl5BanBnXkFtZTgwMzQ0MjMxMDE@._V1_.jpg", 
						"https://youtu.be/JdRGC-w9syA")
wild = media.Video("Into the wild", 
					"After graduating from Emory University, top student and athlete Christopher "
					"McCandless abandons his possessions, gives his entire $24,000 savings account "
					"to charity and hitchhikes to Alaska to live in the wilderness. "
...
green_mile = media.Video("The Green Mile", 
						...
						"https://images-na.ssl-images-amazon.com/images/M/MV5BMTUxMzQyNjA5MF5BMl5BanBnXkFtZTYwOTU2NTY3._V1_.jpg",
...
beautiful_mind = media.Video("A Beautiful Mind", 
							...
							"secret work in cryptography, his life takes a turn for the nightmarish.", 
...
#List of movies
movies = [grease, dirty_dancing, ghost, bodyguard, schindler, wild, green_mile, beautiful_mind, shawshank]
...
lost = media.Video("Lost", 
						...
						"https://images-na.ssl-images-amazon.com/images/M/MV5BMjA3NzMyMzU1MV5BMl5BanBnXkFtZTcwNjc1ODUwMg@@._V1_.jpg", 
...
orange = media.Video("Orange Is the New Black", 
						...
						"to fifteen months in prison after being convicted of a decade-old crime "
						"of transporting money to her drug-dealing girlfriend.", 
						"https://images-na.ssl-images-amazon.com/images/M/MV5BMjMzMjAxNDY5MV5BMl5BanBnXkFtZTgwMzAzNTQxODE@._V1_SY1000_CR0,0,674,1000_AL_.jpg", 
...
americans = media.Video("The Americans", 
							...
							"https://images-na.ssl-images-amazon.com/images/M/MV5BMjAwMzIzOTIyN15BMl5BanBnXkFtZTgwMjU0NTY3MzE@._V1_.jpg", 
...
the_100 = media.Video("The 100", 
						...
						"delinquents back to Earth in hopes of possibly re-populating the planet.", 
						"https://images-na.ssl-images-amazon.com/images/M/MV5BYWIzNDMwNGYtMjk5ZC00ZjA2LTg4ZDgtZmI5NDEzMzdkZTc5XkEyXkFqcGdeQXVyNDExMTIxMDc@._V1_.jpg", 
